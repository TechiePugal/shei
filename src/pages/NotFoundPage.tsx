  ...
  return (
    <>
      <SEO 
        ...
        description="Get in touch with Sudharasan Heavy Engineering Industry for die casting, CNC machining, and engineering solutions. Located in Coimbatore, Tamil Nadu."
